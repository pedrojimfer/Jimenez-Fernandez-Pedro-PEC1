...
Según los resultados obtenidos, se pueden apreciar diferencias claras entre los perfiles metabolómicos de personas pertenecientes al grupo control y pacientes con caquexia. Los resultados del análisis exploratorio de datos revelan que existen metabolitos, como la creatinina, el citrato y el hipurato, con valores altamente elevados en personas que padecen caquexia. Esto sugiere que es posible que exista una asociación entre los procesos fisiopatológicos de la enfermedad con estos tres compuestos metabólicos.
